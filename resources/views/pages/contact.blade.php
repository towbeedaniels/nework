    ...
    <div class="container">
        <div class="page-title-content">
            ...
            <ul>
                ...
                <li class="item"><a href="/contact"><i class='bx bx-chevrons-right'></i>Contact</a></li>
            </ul>
        </div>
    </div>
    <div class="bg-image">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <textarea name="message" id="message" class="form-control" cols="100" rows="6" required=""
            ...
            <div class="row">
                <div class="col-lg-5">
                    <div class="content pt-100 pb-70 ">
                        <div class="info-content">
                            ...
                            <div class="content-list">
                                <i class='bx bx-at'></i>
                                <h6>Email: <a href="https://templates.hibootstrap.com/cdn-cgi/l/email-protection"
                                        class="__cf_email__"
                                        data-cfemail="c8a2a9bda6bc88a1a6aea7e6aba7a5">[email&#160;protected]</a></h6>
                            </div>
                        </div>
                        <div class="info-content">
                            <h3 class="sub-title">Usa Office</h3>
                            <div class="content-list">
                                <i class='bx bx-map'></i>
                            ...
                            <div class="content-list">
                                ...
                                <h6>Email: <a href="https://templates.hibootstrap.com/cdn-cgi/l/email-protection"
                                        class="__cf_email__"
                                        data-cfemail="8ce6edf9e2f8cce5e2eae3a2efe3e1">[email&#160;protected]</a></h6>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-7">
                    <div class="contact-map">
                        <iframe
                            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3291.5587057831294!2d-119.6913566850266!3d34.41256088050952!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x80e9138c16678b21%3A0x224a2a07bdf0842a!2s6%20State%20St%2C%20Santa%20Barbara%2C%20CA%2093101%2C%20USA!5e0!3m2!1sen!2sbd!4v1603126591259!5m2!1sen!2sbd">
                        </iframe>
                    </div>
                </div>
            </div>
